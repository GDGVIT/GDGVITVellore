...
//start learning and using fragments in the place of activities{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.rest)));
        ...
        v1.addItem("p", 80, getResources().getColor(R.color.c2));
        v1.addItem("n", 20, getResources().getColor(android.R.color.white));

        v2 = (CircularView) findViewById(R.id.circle2);
        // v2.setRotateSpeed(3f);
        v2.addItem("p", 65, getResources().getColor(R.color.c2));
        v2.addItem("n", 35, getResources().getColor(android.R.color.white));


        v3 = (CircularView) findViewById(R.id.circle3);
        //v3.setRotateSpeed(3f);
        v3.addItem("p", 70, getResources().getColor(R.color.c2));
        v3.addItem("n", 30, getResources().getColor(android.R.color.white));


        v4 = (CircularView) findViewById(R.id.circle4);
        //  v4.setRotateSpeed(3f);
        v4.addItem("p", 95, getResources().getColor(R.color.c2));
        v4.addItem("n", 05, getResources().getColor(android.R.color.white));
